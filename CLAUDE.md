...
- 002-feature-flags: Added TypeScript 5.x strict mode, React 19.x + Zustand 5.x (new, to be installed), shadcn/ui (existing), Lucide React (existing), date-fns v4 (existing), TanStack Router v1 (existing)
